...
/**
 * An amazing class created by Joshua Bells that allows Bukkit objects to be serialized
 * into JSON using Google's GSON library. Edited to use new Java 7 features, as well as
 * to remove unused methods, and also some minor optimizations.
 *
 * @author SirFaizdat
 * @author Joshua Bells (RingOfStorms)
 */
